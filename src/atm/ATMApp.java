...
public class ATMApp {
            ...
            try {
                ...
                switch (choice) {
                    ...
                    case 2:
                        ...
                        System.out.printf("Deposited PHP %.2f. New balance: PHP %.2f%n", depAmount, account.getBalance());
                        break;
                    case 3:
                    ...
                    case 4:
                        ...
                        System.out.printf("Deposited multiple amounts. Total added: PHP %.2f. New balance: PHP %.2f%n",
                    ...
                    case 5:
                        ...
                        System.out.printf("After tryToReplace() - Balance: PHP %.2f%n", account.getBalance());

                        atm.addBonus(account, 50);
                        System.out.printf("After addBonus(50) - Balance: PHP %.2f%n", account.getBalance());
                        break;
                    case 0:
                        running = false;
                        break;
    ...
    private static void printHeader(Account account) {
        ...
        System.out.println("=================================");
        System.out.println("atm.Account : " + account.getAccountNumber() + "  (" + account.getOwnerName() + ")");
